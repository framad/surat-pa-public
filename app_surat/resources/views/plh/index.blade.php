@extends('layout.main')
@section('title', 'Pelaksana Harian')
@section('css')
    <!-- Data Table CSS -->
...
<div class="hk-pg-wrapper">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="settings"></i></span></span>Pelaksana Harian (PLH)</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <h5 class="hk-sec-title">Pelaksana Harian</h5>
                                <p class="mb-40">Pencatatan Pelaksana Harian</p>
                            </div>
                            <div class="col-sm d-flex justify-content-end align-items-start ">
                                <a class="btn btn-primary btn-wth-icon btn-rounded icon-right" href="{{ url('/catat_plh')}}"><span class="btn-text">Catat PLH Baru</span> <span class="icon-label"><span class="feather-icon"><i data-feather="plus-circle"></i></span> </span></a>
                            </div>
                        </div>
                            <div class="row">
                                <div class="col-sm">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                                    {{-- <a class="dropdown-item" href="{{ url('/plh/'.$item->id.'/edit') }}"><i class="dropdown-icon" data-feather="edit-3"></i><span>Edit</span></a> --}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Hapus Data PLH</h5>
                ...
                <div class="modal-footer">
                    <form method="POST" action="{{ url('/hapus_plh') }}">
                        @csrf
                        <input type="hidden" id="id_plh" name="id_plh">
        ...
        <div class="modal fade" id="ModalHapus{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="GET" action="{{ url('/surat_keluar/'.$item->id.'/hapus') }}">
