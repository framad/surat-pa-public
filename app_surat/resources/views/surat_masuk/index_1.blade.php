                    ...
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm d-flex justify-content-end align-items-start ">
                                <a class="btn btn-primary btn-wth-icon btn-rounded icon-right" href="{{ url('/catat_sm')}}"><span class="btn-text">Surat Baru</span> <span class="icon-label"><span class="feather-icon"><i data-feather="plus-circle"></i></span> </span></a>
                            </div>
                            @endif
                        </div>
                            <div class="row">
