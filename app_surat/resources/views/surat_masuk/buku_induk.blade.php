{{-- @dd($months) --}}
@extends('layout.main')
@section('title', 'Buku Induk Surat Masuk')
@section('css')
    <!-- Data Table CSS -->
...
<div class="hk-pg-wrapper">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="settings"></i></span></span>Buku Induk Surat Masuk</h4>
        </div>
        <!-- /Title -->
...
@section ('toast')
    ...
    <script type="text/javascript">
        ...
        function unduh() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/sm_register_export')}}"+'/'+bulan+'/'+tahun;
        }
        
        function unduh_rhs() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/sm_register_export')}}"+'/'+bulan+'/'+tahun+'/rhs';
        }
    </script>
@endsection
