...
<div class="hk-pg-wrapper">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="mail"></i></span></span>Surat Keluar (BARU)</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <h5 class="hk-sec-title">Data Surat Keluar</h5>
                            ...
                            <div class="col-sm d-flex justify-content-end align-items-start ">
				                @if (
                                    ...
                                    <a class="btn btn-primary btn-wth-icon btn-rounded icon-right" href="{{ url('/catat_sk_baru')}}">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable_1').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    "url": "{{ route('sk_ajax_baru') }}",
                    "type": "GET"
                },
                columns: [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'isi_ringkas', name: 'isi_ringkas'},
