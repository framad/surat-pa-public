@extends('layout.main')
@section('title', 'Catat Surat Keluar Rahasia')
@section('css')
    <!-- Data Table CSS -->
...
<div class="hk-pg-wrapper">
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Surat Keluar Rahasia (BARU)</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="mail"></i></span></span>Surat Keluar Rahasia (BARU)</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <h5 class="hk-sec-title">Data Surat Keluar Rahasia</h5>
                                <p class="mb-40">Pencatatan Surat Keluar Rahasia</p>
                            </div>
                            @if(
                                Auth::user()->role==1
                                && date('Y') == session()->get('tahun_anggaran')
                                )
                                <div class="col-sm d-flex justify-content-end align-items-start ">
                                    <a class="btn btn-primary btn-wth-icon btn-rounded icon-right" href="{{ url('/catat_sk_baru/rhs')}}">
                                        <span class="btn-text">Catat Surat Baru</span> 
                                                            ...
                                                            @if (Auth::user()->role!=5 && Auth::user()->role!=3)
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                                        <a class="dropdown-item" href="{{ url('/surat_keluar_baru/'.$item->enc_id.'/edit') }}"><i class="dropdown-icon" data-feather="edit-3"></i><span>Edit</span></a>
                                                                        <a class="dropdown-item" href="#" onclick="hapus('{{$item->id}}')"><i class="dropdown-icon" data-feather="trash"></i><span>Hapus</span></a>
                                                                        <a class="dropdown-item" href="{{ url('/kirim_pta/'.$item->enc_id) }}"><i class="dropdown-icon" data-feather="send"></i><span>Kirim ke PTA</span></a>
                                                                        <a class="dropdown-item" href="{{ url('/surat_keluar_baru/'.$item->enc_id.'/lihat') }}"><i class="dropdown-icon" data-feather="eye"></i><span>Lihat</span></a>
    ...
    <div class="modal fade" id="ModalHapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="POST" action="{{ url('/hapus_sk_baru') }}">
                        @csrf
