...
<div class="hk-pg-wrapper">
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Catat Surat Keluar {{ $rhs ? 'Rahasia' : '' }} (BARU)</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
                ...
                <section class="hk-sec-wrapper">
                    <div class="row">
                        ...
                        <div class="col-sm d-flex justify-content-end align-items-start ">
                            ...
                            <a class="btn btn-indigo btn-wth-icon btn-rounded icon-left" href="{{ url( $rhs ? '/surat_keluar_rhs_baru':'/surat_keluar_baru') }}">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <form action="{{ url('/simpan_sk_baru')}}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control" id="penandatangan_surat" name="penandatangan_surat" 
                                            placeholder="Penandatangan Surat" value="" type="text" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="custom-select" id="jabatan_penandatangan_surat" name="jabatan_penandatangan_surat" required>
                                            ...
                                            <option value="KPA">Ketua (KPA)</option>
                                            <option value="WKPA">Wakil Ketua (WKPA)</option>
                                            <option value="PAN.PA">Panitera (PAN.PA)</option>
                                            <option value="PAN.01">Panmud Permohonan (PAN.01)</option>
                                            <option value="PAN.02">Panmud Gugatan (PAN.02)</option>
                                            <option value="PAN.03">Panmud Hukum (PAN.03)</option>
                                            <option value="SEK.PA">Sekretaris (SEK.PA)</option>
                                            <option value="SEK.01">Kasubbag PTIP (SEK.01)</option>
                                            <option value="SEK.02">Kasubbag Kepegawaian Ortala (SEK.02)</option>
                                            <option value="SEK.03">Kasubbag Umum Keuangan (SEK.03)</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="custom-select" id="sifat_surat" name="sifat_surat" required>
                                            <option value="0" selected>--Pilih Sifat--</option>
                                            @if ($rhs==NULL)
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea class="form-control" placeholder="isi ringkas" name="isi_ringkas" rows="3" required></textarea>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" id="pejabat_backdate" required>
                        <option selected>--Pilih Jabatan--</option>
                        <option value="KPA">Ketua (KPA)</option>
                        <option value="WKPA">Wakil Ketua (WKPA)</option>
                        <option value="PAN.PA">Panitera (PAN.PA)</option>
...
<script type="text/javascript">
    ...
    function cariNomor(rhs) {
        ...
        var pejabat = $('#pejabat_backdate').val();
        $.ajax({
           type:'POST',
           url:"{{ route('nomor.cari.baru') }}",
           data:{tanggal,rhs,pejabat},
           success:function(data) {
                // console.log(data);
