...
<body>
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url({{ asset('images/gedung1.jpeg')}});">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url({{ asset('images/gedung2.jpeg')}});">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    {{-- <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form action="{{url('/auth')}}" method="POST">
                                    ...
                                    <p class="mb-30">Masukan username dan password anda</p>
    ...
    <script src="{{ asset('style/marvin/html')}}/dist/js/login-data.js"></script>
</body>
