{{-- @dd($months) --}}
@extends('layout.main')
@section('title', 'Buku Induk Surat Keluar')
@section('css')
    <!-- Data Table CSS -->
...
<div class="hk-pg-wrapper">
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Buku Induk</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="settings"></i></span></span>Buku Induk Surat Keluar</h4>
        </div>
        <!-- /Title -->
                            ...
                            <div class="col-sm">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group d-flex justify-content-start align-items-start ">
                                        ...
                                        @if(Auth::user()->role==1)
                                        <a class="btn btn-danger btn-wth-icon btn-rounded icon-right" href="#" onclick="unduh_rhs()">
                                            <span class="btn-text">Download Surat Rahasia</span> 
                                            <span class="icon-label">
                                                <span class="feather-icon"><i data-feather="download"></i>
                                            </span>
                                            </span>
                                        </a>
                                        @endif
...
@section ('toast')
    ...
    <script type="text/javascript">
        ...
        function unduh() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/sk_register_export')}}"+'/'+bulan+'/'+tahun;
        }
        
        function unduh_rhs() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/sk_register_export')}}"+'/'+bulan+'/'+tahun+'/rhs';
        }
    </script>
@endsection
