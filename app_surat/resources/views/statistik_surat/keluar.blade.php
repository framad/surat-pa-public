@extends('layout.main')
@section('title', 'Statistik Surat Keluar')
@section('css')
    <!-- Data Table CSS -->
...
<div class="hk-pg-wrapper">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="settings"></i></span></span>Statistik Surat Keluar</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                            ...
                            <div class="col-sm">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group d-flex justify-content-end align-items-start ">
                                        ...
                                        {{-- <a class="btn btn-success btn-wth-icon btn-rounded icon-right" href="{{ url('/statistik_sk/export')}}"><span class="btn-text">Download</span> <span class="icon-label"><span class="feather-icon"><i data-feather="plus-circle"></i></span> </span></a> --}}
                                        <a class="btn btn-success btn-wth-icon btn-rounded icon-right" href="#" onclick="unduh()"><span class="btn-text">Download</span> <span class="icon-label"><span class="feather-icon"><i data-feather="plus-circle"></i></span> </span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table id="datable_1" class="table table-hover w-100 display pb-30 table-statistik">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode</th>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-50 form-group">
                                <h4>Klasifikasi Surat Detail</h4>
                            </div>

                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table id="datable_detail" class="table table-hover w-100 display pb-30 table-statistik">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode</th>
...
@section ('toast')
    ...
    <script type="text/javascript">
        ...
        //     $.ajax({
        //         type:'POST',
        //         url:"{{ route('statistik.keluar.tampil') }}",
        //         data:{bulan, tahun},
        ...
        function tampilkan() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/statistik_sk')}}" + "?bulan=" + bulan + "&tahun=" + tahun;
        }

        function unduh() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/statistik_sk/export')}}"+'/'+bulan+'/'+tahun;
        }
    </script>
@endsection