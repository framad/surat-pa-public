            ...
            <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table id="datable_detail" class="table table-hover w-100 display pb-30 table-statistik-detail">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Kode</th>
...
@section ('toast')
    ...
    <script type="text/javascript">
        ...
        function tampilkan() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/statistik_sm')}}" + "?bulan=" + bulan + "&tahun=" + tahun;
        }

        function unduh() {
            var bulan = $("#bulan").val();
            var tahun = $("#tahun").val();
            window.location.href = "{{ url('/statistik_sm/export')}}"+'/'+bulan+'/'+tahun;
        }
    </script>
@endsection
