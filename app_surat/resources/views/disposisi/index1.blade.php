                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                                        @if(isset($item->sifat_surat) && $item->sifat_surat > 0)
                                                                            <a class="dropdown-item" href="{{ url('/disposisi/'.$item->id_surat.'/'.$item->id) }}"><i class="dropdown-icon" data-feather="eye"></i><span>Lihat Disposisi</span></a>
                                                                            @if($item->teruskan <> 1 and $level <= 4)
                                                                                @if(($item->jenis<2 && !$item->plh)) {{-- jenis 2 = sudah di-disposisi --}}
            ...
            <div class="modal fade" id="ModalReview{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {{-- <form method="POST" action="/disposisi/updateSifatSurat/{{$item->id_surat_masuk}}"> --}}
