...
<div class="hk-pg-wrapper">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="mail"></i></span></span>Disposisi</h4>
        </div>
        <!-- /Title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm d-flex justify-content-end align-items-start ">
                                ...
                                @if($level <= 4 && (!$disposisi->plh || ($disposisi->plh==Auth::user()->nip)))
                                    <a class="btn btn-primary btn-wth-icon btn-rounded icon-right" href="{{ url('/disposisi/create/'.$suratmasuk->id.'/'.$id)}}"><span class="btn-text">
                                            ...
                                            @foreach ($history as $row) 
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $row->oleh }}
                                                        <br/>
                                                        {{ $row->jenis==1 ? 'Meneruskan Ke':'Disposisi Ke' }}
                                                        <br/>
                                                        {{ $row->kepada }}
                                                        @if($row->pelaksana)
                                                        <br/>
