...
class KlasifikasikeluarExport implements FromView, WithColumnWidths, WithStyles // FromArray, WithHeadings, WithColumnWidths, 
{
    protected $bulan;
    protected $tahun;
    protected $row = 0;
    ...
    public function view(): View
    {
        ...
        $sql_detail = "SELECT p.kode parent, k.kode, k.nama, k.uraian, count(k.id) jumlah
                ...
                WHERE LEFT(sk.tanggal_surat, 7)=? GROUP BY k.id, k.kode, k.nama, k.uraian, p.kode ORDER BY k.kode";
        ...
        return view('statistik_surat.export_sk', [
            'data' => $data,
